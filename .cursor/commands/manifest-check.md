...
3. Dependencies that only used in `#![cfg(test)]` should be added to `[dev-dependencies]` instead of `[dependencies]`.
4. Use `zepter` cli to check the features are propagated correctly in the manifest.
